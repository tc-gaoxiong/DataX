...
public class ReaderRunner extends AbstractRunner implements Runnable {
  ...
  public void run() {
    ...
    PerfRecord channelWaitWrite = new PerfRecord(
            getTaskGroupId(), getTaskId(),
    ...
    try {
      ...
      PerfRecord initPerfRecord = new PerfRecord(
              getTaskGroupId(), getTaskId(),
      ...
      PerfRecord preparePerfRecord = new PerfRecord(
              getTaskGroupId(), getTaskId(),
      ...
      PerfRecord dataPerfRecord = new PerfRecord(
              getTaskGroupId(), getTaskId(),
      ...
      PerfRecord postPerfRecord = new PerfRecord(
              getTaskGroupId(), getTaskId(),
      ...
      PerfRecord desPerfRecord = new PerfRecord(
              getTaskGroupId(), getTaskId(),
      ...
      if (transformerUsedTime > 0) {
        PerfRecord transformerRecord = new PerfRecord(
                getTaskGroupId(), getTaskId(),
