...
public class CoreConstant {
  ...
  public static String DATAX_CONF_PATH = StringUtils.join(
          new String[]{
  ...
  public static String DATAX_SECRET_PATH = StringUtils.join(
          new String[]{
  ...
  public static String DATAX_BIN_HOME = StringUtils.join(
          new String[]{
                  DATAX_HOME, "bin"}, File.separator);

  public static String DATAX_JOB_HOME = StringUtils.join(
          new String[]{
