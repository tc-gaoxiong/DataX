    ...
    public static class TaskCommunication {
        ...
        public void report(Communication communication) {
            ...
            if (CommunicationTool.getTotalReadRecords(communication) > lastAllReadRecords) {
                ...
                communication.setThrowable(DataXException.asDataXException(
                        CommonErrorCode.TASK_HUNG_EXPIRED,
                        String.format(
                                "task(%s) hung expired [allReadRecord(%s), elased(%s)]",
                                taskId,
                                lastAllReadRecords,
                                (ttl - lastUpdateComunicationTS))));
            }
        }
