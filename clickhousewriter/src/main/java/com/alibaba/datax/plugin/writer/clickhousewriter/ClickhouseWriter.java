  ...
  public static class Task extends Writer.Task {
    ...
    public void init() {
      ...
      this.commonRdbmsWriterSlave = new CommonRdbmsWriter.Task(DATABASE_TYPE) {
        ...
        boolean fillPreparedStatementColumnType4CustomType(
          ...
          switch (columnSqltype) {
            case Types.OTHER:
              if (this.resultSetMetaData.getRight().get(columnIndex).startsWith("Tuple")) {
                throw DataXException
                        .asDataXException(
                                ClickhouseWriterErrorCode.TUPLE_NOT_SUPPORTED_ERROR,
                                ClickhouseWriterErrorCode.TUPLE_NOT_SUPPORTED_ERROR.getDescription());
              } else {
    ...
    public void startWrite(RecordReceiver recordReceiver) {
      this.commonRdbmsWriterSlave.startWrite(
              recordReceiver,
