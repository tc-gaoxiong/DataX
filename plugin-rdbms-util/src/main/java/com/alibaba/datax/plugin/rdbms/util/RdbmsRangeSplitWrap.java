...
public final class RdbmsRangeSplitWrap {
  ...
  public static List<String> splitAndWrap(
          String left, String right, int expectSliceNumber,
  ...
  public static List<String> wrapRange(
          String[] rangeResult, String columnName,
  ...
  public static String wrapFirstLastPoint(
          String firstPoint, String lastPoint, String columnName,
          String quote, DataBaseType dataBaseType) {
    return String.format(
            " ((%s < %s%s%s) OR (%s%s%s < %s)) ",
            columnName,
            quote,
            quoteConstantValue(firstPoint, dataBaseType),
            quote,
            quote,
            quoteConstantValue(lastPoint, dataBaseType),
            quote,
            columnName);
  }
  ...
  public static String wrapFirstLastPoint(
          BigInteger firstPoint,
          BigInteger lastPoint,
          String columnName) {
    return wrapFirstLastPoint(firstPoint.toString(), lastPoint.toString(), columnName, "", null);
  }
  ...
  private static String quoteConstantValue(String aString, DataBaseType dataBaseType) {
    ...
    if (dataBaseType.equals(DataBaseType.MySql)) {
      return aString.replace("'", "''").replace("\\", "\\\\");
            ...
            || dataBaseType.equals(DataBaseType.SQLServer)) {
